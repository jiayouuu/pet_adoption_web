  ...
  <div style="min-height: calc(100vh - 60px); margin: 10px 0">
    ...
    <div style="padding: 30px 0">
      ...
      <div style="margin: 10px 0">
        <el-input  type="textarea" v-model="form.content" placeholder="请发表评论"></el-input>
        <div style="text-align: right; padding: 10px 0"><el-button type="primary"  @click="saveComment"> 评论</el-button></div>
      </div>
