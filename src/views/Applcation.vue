<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 200px" size="large"  placeholder="请输入领养人姓名" suffix-icon="iconfont icon-r-find" v-model="name"></el-input>
    </div>
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload :action="$store.state.baseApi+'/applcation/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="animal.nickname" label="领养动物"></el-table-column>
      <el-table-column prop="name" label="姓名"></el-table-column>
      <el-table-column prop="sex" label="性别"></el-table-column>
      <el-table-column prop="age" label="年龄"></el-table-column>
      <el-table-column prop="experience" label="养宠经验"></el-table-column>
<!--      <el-table-column prop="pet" label="宠物"></el-table-column>-->
      <el-table-column prop="phone" label="联系方式"></el-table-column>
      <el-table-column prop="married" label="婚姻"></el-table-column>
      ...
      <el-table-column label="操作"  fixed="right"   width="520" align="center">
        <template slot-scope="scope">
          <el-button type="success" @click="changeState(scope.row, '审核通过')" :disabled="scope.row.state !== '待审核'"> 通过 </el-button>
          <el-button type="danger" @click="changeState(scope.row, '审核不通过')" :disabled="scope.row.state !== '待审核'"> 不通过 </el-button>
          <el-button type="primary" @click="handleEdit(scope.row)"  :disabled="scope.row.state !== '待审核'"> 编辑 </el-button>
          <el-popconfirm
              class="ml-5"
              confirm-button-text='确定'
              cancel-button-text='我再想想'
